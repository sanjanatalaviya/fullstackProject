    ...
    <div>
                        ...
                        <div className="rounded position-relative fruite-item">
                          ...
                          <div className="p-4 border border-secondary border-top-0 rounded-bottom">
                            ...
                            <div className="d-flex justify-content-between flex-lg-wrap">
                              ...
                              <Button btnType="primary"><i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart </Button>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className="container-fluid vesitable py-5">
        <div className="container py-5">
          ...
          <OwlCarousel {...carouselOpt} className="owl-carousel vegetable-carousel justify-content-center">
            ...
            <div className="row g-4 justify-content-center">
              <div className="col-md-6 col-lg-6 col-xl-3">
                <div className="counter bg-white rounded p-5">
                  {/* className={`counter rounded p-5${themecontext.theme}`}> */}
      ...
      <div className="container-fluid testimonial py-5">
        <div className="container py-5">
          ...
          <OwlCarousel {...tresminonialOpt} loop margin={10} nav className="owl-carousel testimonial-carousel">
