...
function Contact(props) {
    let contactSchema = object({
        ...
        email: string().required("please enter email").email("please enter valid email.."),
        message: string().required("please enter message").min(5, "please enter atleast 5 charecter in message."),
    });
