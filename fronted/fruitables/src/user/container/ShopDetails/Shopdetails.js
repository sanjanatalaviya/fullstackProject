...
function Shopdetails(props) {
    ...
    try {
        ...
        //     const fruitdetaildata = data.find((v) => v.id === id);
        //     setfruitdata(fruitdetaildata);
        //     console.log(data);
        // }
                            ...
                            <div className="row g-4">
                                <div className="col-lg-6">
                                    <div className="border rounded">
                                        <a href="#">
                                            <img src={`../${fruitdata.image}`} className='img-fluid rounded' alt='Image' />
                                        </a>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <h4 className="fw-bold mb-3">{fruitdata.name}</h4>
                                    <p className="mb-3">Category: Vegetables</p>
                                    <h5 className="fw-bold mb-3">{fruitdata.price} $</h5>
                                    ...
                                    <p className="mb-4">{fruitdata.description}</p>
